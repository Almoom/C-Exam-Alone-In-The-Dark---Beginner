...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/27 13:33:53 by ljalikak          #+#    #+#             */
/*   Updated: 2019/06/27 13:33:55 by ljalikak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**------------------------------------------------------------------------------
**
**Write a program that takes an undefined number of strings in arguments. For
**each argument, the program prints on the standard output "OK" followed by a
**newline if the expression is correctly bracketed, otherwise it prints "Error"
